...
Datum und Zeit - Importieren Sie das Modul datetime und informieren Sie den Benutzer beim 
Generieren des Passworts um das aktuelle Datum und die Uhrzeit.

Fallunterscheidung beim Generieren - Ergänzen Sie die Passwort-Generator-Funktion um die Möglichkeit, 
Sonderzeichen optional ein- oder auszuschalten.
-> Lösung: Siehe Zeile 97
...
Programmablauf:
generate_password() -> ask_for_password_details() -> build_password() -> shuffle_password() -> get_current_time()
'''
...
def ask_for_password_details():
    ...
    try:
        ...
        number_of_special_characters = 0 # optional special characters
...
def get_current_time():
    return datetime.datetime.now().strftime("%d.%m.%Y %H:%M:%S") # 26.09.2021 15:00:00

print(f"Your password: {generate_password()}")
print(f"Password generated at: {get_current_time()}")